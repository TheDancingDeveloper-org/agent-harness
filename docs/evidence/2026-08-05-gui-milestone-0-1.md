...
> Historical branch evidence. This records commands and behavior on
> `codex/gui-plan` through `deed5a1`; it is not verification of the later import
> onto the current core tree. Current implementation and remaining work live in
> [`docs/STATUS.md`](../STATUS.md) §2.8.
